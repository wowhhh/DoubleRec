                ...
                <div class="col-sm-4">
                   ...
                   <div class="panel-body">
                  	...
                  	<div class="doc-buttons" >
                  			 <FORM id="selectedbutton" name=form1 action="${ pageContext.request.contextPath }/user_registRec2.action"  onsubmit="return checkForm();" method=post>
                  				...
                  				<button type="submit" class="btn btn-sm btn-default" onclick="isuser()">提交</button>
                  			</FORM>
                  	</div>
                   </div>
                 ...
                 <div class="col-sm-4">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">系统记录的您的音乐口味（可以重复选择）：</div>

                   <div class="panel-body">
                   
                  	<div class="doc-buttons" >
                  	<s:if test="userandsltype !=null">
                  	<s:iterator var="ust" value="userandsltype">
                  			 <a href="#" class="btn btn-s-md btn-warning"><s:property value="#ust.typeName" /> * <s:property value="#ust.times" /></a>
                  	</s:iterator>
                  	</s:if>
                  	<s:else>
                  		<a href="#" class="btn btn-s-md btn-danger">不登录不显示emmmmmm</a>
                  	</s:else>
                  	</div>
                   </div>
